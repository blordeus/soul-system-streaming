...
const DEFAULT_ALBUM = {
  ...
  title: "Soul System (Instrumentals)",
  releaseDate: "2025-11-08",
  cover: "/img/soul-system-cover.png",
  links: { spotify: "", apple: "", bandcamp: "" },
  tracks: [
    { id: "t1", title: "01 — Dawn Transit", src: "/audio/01.mp3" },
    { id: "t2", title: "02 — Solar Drift", src: "/audio/02.mp3" },
    { id: "t3", title: "03 — Halo Engine", src: "/audio/03.mp3" },
    { id: "t4", title: "04 — Gravity Echo", src: "/audio/04.mp3" },
    { id: "t5", title: "05 — Neon Orbit", src: "/audio/05.mp3" },
    { id: "t6", title: "06 — Liminal Field", src: "/audio/06.mp3" },
    { id: "t7", title: "07 — Quartz Pulse", src: "/audio/07.mp3" },
    { id: "t8", title: "08 — Black Sky", src: "/audio/08.mp3" },
    { id: "t9", title: "09 — Ion Rain", src: "/audio/09.mp3" },
    { id: "t10", title: "10 — Meridian", src: "/audio/10.mp3" },
    { id: "t11", title: "11 — Cold Fire", src: "/audio/11.mp3" },
    { id: "t12", title: "12 — Blue Shift", src: "/audio/12.mp3" },
    { id: "t13", title: "13 — Night Signal", src: "/audio/13.mp3" }
  ]
};
...
export default function App(){
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{backgroundColor:BRAND.colors.bg,fontFamily:BRAND.fontFamily}}>
      ...
      <style>{`body::before {content:'';position:fixed;top:0;left:0;right:0;bottom:0;background:url('/img/noise-texture.png');background-size:cover;opacity:0.15;pointer-events:none;z-index:0;}`}</style>
    </div>
  );
}
