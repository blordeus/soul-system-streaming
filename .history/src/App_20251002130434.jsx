  ...
  <main className="flex-1 grid grid-cols-1
    ...
    <div className="flex flex-col">
      ...
      <div className="flex items-center gap-2 justify-center lg:justify-start">
        ...
        <button onClick={togglePlay} className="p-3 rounded-full bg-${BRAND.colors.accent} ] text-black hover:bg-[var(--accentSecondary)] hover:text-white transition-colors">
