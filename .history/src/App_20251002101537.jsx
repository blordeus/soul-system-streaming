...
function PlayerUI({ ALBUM, BRAND, embed=false }) {
  ...
  style={{
    background: `linear-gradient(to top, transparent 0%, rgba(0,0,0,0.6) 100%), linear-gradient(90deg, ${BRAND.colors.accent} 0%, ${BRAND.colors.accentSecondary} 50%, ${BRAND.colors.accent} 100%)`,
    // color: "#fff",
