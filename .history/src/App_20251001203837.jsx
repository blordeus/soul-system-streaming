...
export default function App(){
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{backgroundColor:BRAND.colors.bg,fontFamily:BRAND.fontFamily}}>
      ...
      <style>{`body::before {content:'';position:fixed;top:0;left:0;right:0;bottom:0;background:url('/public/img/noise-texture.png');background-size:cover;opacity:0.15;pointer-events:none;z-index:0;}`}</style>
    </div>
  );
}
