      ...
      <main className="flex-1 grid grid-cols-1
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-2 justify-center lg:justify-start">
            <button onClick={()=>setIndex(prevIndex())} className="p-2 rounded-full bg-[#f5b14b] hover:bg-[#7a5cff] hover:text-white transition-colors"><SkipBack className="w-4 h-4"/></button>
            ...
            <button onClick={()=>setIndex(nextIndex())} className="p-2 rounded-full bg-[#f5b14b] hover:bg-[#7a5cff] hover:text-white transition-colors"><SkipForward className="w-4 h-4"/></button>
          </div>
