...
const DEFAULT_ALBUM = {
  ...
  cover: "C:\Users\lena\Downloads\soul-system-player-github\public\img\FINAL-Soul-System-Cover.PNG",
  links: {
  ...
  tracks: [
    ...
    { id: "t1", 
      title: "Reboot", 
      src: "/audio/01.reboot.mp3", 
      durationHint: 0 },
    { id: "t2", 
      title: "Summer Solace", 
      src: "/audio/02.summer-solace.mp3", 
      durationHint: 0 },
    {
      id: "t3",
      title: "In the Wilderness",
      src: "/audio/03.in-the-wilderness.mp3",
      durationHint: 0,
    },
    { id: "t4", 
      title: "Butterflies", 
      src: "/audio/04.butterflies.mp3", 
      durationHint: 0 },
    {
      id: "t5",
      title: "Foggy Night of the Soul",
      src: "/audio/05.foggy-night-of-the-soul-(v2).mp3",
      durationHint: 0,
    },
    {
      id: "t6",
      title: "It Was All a Dream",
      src: "/audio/06.it-was-all-a-dream.mp3",
      durationHint: 0,
    },
    {
      id: "t7",
      title: "Blaque Nostalgia",
      src: "/audio/07.blaque-nostalgia-(v5).mp3",
      durationHint: 0,
    },
    { id: "t8", 
      title: "New Habits", 
      src: "/audio/08.new-habits.mp3", 
      durationHint: 0 },
    {
      id: "t9",
      title: "Childlike Wonder",
      src: "/audio/09.childlike-wonder.mp3",
      durationHint: 0,
    },
    { id: "t10", 
      title: "You Make The Sun Rise", 
      src: "/audio/10.you-make-the-sun-rise.mp3", 
      durationHint: 0 },
    { id: "t11", 
      title: "System Shift", 
      src: "/audio/11.system-shift.mp3", 
      durationHint: 0 },
    {
      id: "t12",
      title: "A Muse Sings",
      src: "/audio/12.another-Astrud-flip-(v4)mp3",
      durationHint: 0,
    },
     {
      id: "t13",
...
const DEFAULT_BRANDING = {
  ...
  fontFamily:
    'var(--font, "Gontserrat", Montserrat, Sora, Poppins, Inter, ui-sans-serif)',
...
function PlayerUI({ ALBUM, BRAND, embed = false }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
        ...
        <h1 className="text-[20px] md:text-4xl lg:text-6xl font-bold tracking-wide text-white">
          {BRAND.appName}
        </h1>
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-2 justify-center lg:justify-start">
            ...
            >
              <Shuffle
                className={`w-4 h-4 ${shuffle ? "text-white" : "text-black"}`}
              />
            </button>
            ...
            <button
              ...
              className="p-2 rounded-full transition"
              style={{
                background: repeatMode === "off" ? "#cfa56a" : "#7a5cff",
              }}
              title={`Repeat: ${repeatMode}`}
            >
              <Repeat
                className={`w-4 h-4 ${
                  repeatMode === "off" ? "text-black" : "text-white"
                }`}
              />
            </button>
          </div>
          ...
          <div className="mt-4 flex items-center gap-3 justify-center lg:justify-start">
            <button
              ...
              className="p-2 rounded-full transition"
              style={{
                background: muted || volume === 0 ? "#cfa56a" : "#f5b14b",
              }}
  ...
  "
              style={{
                "--accent":
                  volume > 0.7 ? BRAND.colors.accent : BRAND.colors.accentMuted,
                boxShadow: `0 0 6px ${
                  volume > 0.7 ? BRAND.colors.accent : BRAND.colors.accentMuted
                }`,
              }}
            ...
            {ALBUM.tracks.map((t, i) => (
              <li key={t.id}>
                ...
                >
                  ...
                  <span
                    className={`text-xs ${
                      i === index ? "text-black/70" : "text-zinc-300/80"
                    }`}
                  >
    ...
    <div
      ...
      style={{
        ...
        backgroundImage: BRAND.backgroundImage
          ? `linear-gradient(rgba(5,5,6,0.6), rgba(5,5,6,0.6)), url(${asset(
