...
export default function App(){
  ...
  const scannerRef = useRef(null);                        // offscreen <audio> for scanning
  const [scanned, setScanned] = useState(false);          // run scan once after first gesture
...
>
  ...
  {/* Main audio element (handles playback + seek + duration) */}
<audio
  ref={audioRef}
  src={asset(track?.src)}
  preload="metadata"
...
{/* Hidden scanner audio (loads metadata for all tracks, once) */}
<audio ref={scannerRef} style={{ display: "none" }} />
